...
if($_SESSION['loggedin']==true){
    ...
    if(isset($_GET['logout'])){
        ...
        $rid =$_POST['rideId'];
        $Pay = $_POST['payement'];
          $sql4 = "Update booking_detail set Payment = '$Pay', ride_status='Completed' where id = '$rid' ";
         echo $sql4;
        $result4 = mysqli_query($conn,$sql4);
        if($result4==true){
    ...
    <div class="grid-container">
        ...
        <main class="main-container">
            ...
            <div id="container">
                <div class="container">
                    <h2>Update Ride</h2>
                    <form  autocorrect ="off" autocomplete="off" action="completeRide.php" method="POST">
                    <input style="color: black; visibility:hidden;"  readonly autocorrect ="off" value="<?php echo $row3['id'];?>" aria-autocomplete="off" autocomplete="off" type="text" id="rideId" name="rideId" required> 
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="payement">Payment<span style="color: #f90d0d;">*</span></label>
                            <input autocomplete="off"   value="<?php echo $row3['payment'];?>"  type="tel" id="payement" name="payement" required>
                        </div>
                        <label>* indicate required fields</label>
                        <!-- Add more fields as needed -->
                        <button type="submit" name="update-ride"  class="button">Set as Completed</button>
                    </form>
                </div>
            </div>
