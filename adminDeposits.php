...
if($_SESSION['loggedin']==true){
    ...
    $expense_type = 'BankDeposit';
$sql6 = "SELECT * FROM expenses_details e left JOIN driver_details d ON e.driver_id = d.id WHERE 1=1 AND type = '$expense_type' ";
...
$expense_type = 'BankDeposit';
$sql7 = "SELECT ifNULL(SUM(total),0) AS total FROM expenses_details WHERE 1=1 AND type = '$expense_type'";
