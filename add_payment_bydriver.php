           ...
           <div id="container">
                <div class="container">
                    ...
                    <div class="form-group">
                            <label for="profileImage">Select Expense Type</label>
                            
                            <select class="selector" name="expensetype" id = "expensetype">
                                <option value="" >-------------</option>
                                <option value="CarWash" >Car wash</option>
                                <option value="Fuel" >Fuel</option>
                                <option value="Maintenance" >Maintinance</option>
                                <option value="Misc" >Misc</option>
                                <option value="BankDeposit" >Bank Desposit</option>
