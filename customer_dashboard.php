...
<head>
    ...
    <style>
        * {
        ...
        #map {
            height: 400px; /* Make sure the map has a defined height */
            width: 100%;
            margin-top: 20px;
        }
...
<body>
    ...
    <script>
        // Initialize the map after window is fully loaded
        ...
        window.onload = function () {
            ...
            map.on('click', function (e) {
                ...
                selectedLocationType = ''; // Reset after use
            });
        };
            ...
            fetch(`https://nominatim.openstreetmap.org/reverse?lat=${latlng.lat}&lon=${latlng.lng}&format=json`)
                ...
                .then(data => {
                    if (data && data.display_name) {
                        document.getElementById(outputId).value = data.display_name;
                    }
                })
                .catch(err => {
                    console.error(err);
